...
STORAGE SORT
Sort the food storage (top right of map) by food type! Click and drag each item to its corresponding box.
Success: +2%
Fail: -2%

LANTERNS
Talk to Monty Jack, found southeast of the statue. He asks you to help set up his lanterns. Walk around town to find each lamp post and press E to set up a lantern. Return to Monty Jack once all lanterns are set.
Completion: +2%

CHEESE TAX
This task can only be done if the “Sunflower Seed Delivery” quest has not been completed. Talk to Cheese Louise west of the fountain at the market. She will ask Briea her thoughts on the cheese tax.
For it: +2%
Should be higher: -2%
...
BITTEN STATUE
Once the player reaches 2 cheese actions, the statue quest will unlock in the town center. Someone has taken a bite out of the statue, Briea needs to help Emment find out who!
Blame Ric Otto: -2%
Tell the truth: +2%
