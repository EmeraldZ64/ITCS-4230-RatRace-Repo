...
[
	new dialoguePage("Goose", "BRIEA! My favorite almost-mayor-slash-part-time-menace! Look at you out here makin' the whole burrow nervous with your political rizz."),
	...
	new dialoguePage("Goose", "Gimme one! Lemme rep the brand! Gotta support my bestie-slash-former-partner-in-crime!", , ,
		[
		new dialogueChoice("Give Button", 3, GOOD, , obj_qTutorial.giveButton),
		new dialogueChoice("Keep Button", 5)
		]),
