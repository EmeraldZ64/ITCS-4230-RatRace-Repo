...
[
	new dialoguePage("Briea","Oh my gouda gracious!"),
	new dialoguePage("Briea","Someone chomped the founder's face! Who does that?"),
	...
	[
		new dialogueChoice("Help Out", 7, , "Statue"),
		new dialogueChoice("Help Later", 6)
	]),
	// 6 - not accept yet
	...
	[
		new dialogueChoice("Blame Ric Otto", 11, , , obj_qStatue.decisionBad),
		new dialogueChoice("Tell the Truth", 14, , , obj_qStatue.decisionGood),
	]),
